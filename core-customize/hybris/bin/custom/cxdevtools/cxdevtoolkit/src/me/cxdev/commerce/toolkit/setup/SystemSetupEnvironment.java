...
public final class SystemSetupEnvironment {
	...
	@VisibleForTesting
	static final String LEGACYMODEKEY = "cxdevtoolkit.impeximport.configuration.legacymode";
	@VisibleForTesting
	static final String ENABLECODEEXECUTIONKEY = "cxdevtoolkit.impeximport.configuration.enablecodeexecution";
	@VisibleForTesting
	static final String VALIDATIONMODEKEY = "cxdevtoolkit.impeximport.configuration.validationmode";
	@VisibleForTesting
	static final String DEFAULTLOCALEKEY = "cxdevtoolkit.impeximport.configuration.defaultlocale";
	@VisibleForTesting
	static final String ISDEVELOPMENTKEY = "cxdevtoolkit.impeximport.environment.isdevelopment";
	@VisibleForTesting
	static final String SUPPORTLOCALIZATIONKEY = "cxdevtoolkit.impeximport.environment.supportlocalizedfiles";
	@VisibleForTesting
	static final String LASTPROCESSEDRELEASEVERSIONKEY = "cxdevtoolkit.impeximport.configuration.lastprocessedreleaseversion";
	@VisibleForTesting
	static final String LASTPROCESSEDRELEASEITEMSKEY = "cxdevtoolkit.impeximport.configuration.lastprocessedreleaseitems";
	@VisibleForTesting
	static final String FILE_HEADER = "This file is generated automatically by the cxdevtoolkit extension. Do not change the file manually!";
